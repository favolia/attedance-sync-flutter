...
import 'features/machine_finger/presentation/add_machine/add_machine_page.dart';
    ...
    ShellRoute(
      ...
      routes: [
        ...
        GoRoute(
            ...
            routes: [
              GoRoute(
                name: 'addMachineFingerPage',
                path: 'add/:addMachineFingerPage',
                builder: (context, state) => const AddMachineFingerPage(),
              ),
            ]),
        GoRoute(
          path: '/work-location',
